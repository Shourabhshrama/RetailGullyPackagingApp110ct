...
public class OrderList implements Serializable, Parcelable
{
    ...
    public final static Parcelable.Creator<OrderList> CREATOR = new Creator<OrderList>() {
        ...
        public OrderList[] newArray(int size) {
            ...
            ;
    private final static long serialVersionUID = 6508343217716768750L;
    ...
    protected OrderList(Parcel in) {
        ...
        this.baseGrandTotal = ((Double) in.readValue((Double.class.getClassLoader())));
        ...
        this.baseShippingDiscountAmount = ((String) in.readValue((String.class.getClassLoader())));
